                        ...
                        <div class="row g-0">
                            ...
                            <div class="card-body p-md-5 mx-md-4">
                                ...
                                <h4 class="mt-2 pb-1"><span style="color:#fff">.</span></h4>
                                    ...
                                    <form method="POST" action="{{ route('updateSecurityQuestions') }}">
                                        @csrf

                                        <!-- Greeting with dynamic username -->
                                        <p class="h5 mb-4">
                                            {{ __('messages.Hey :username', [], session()->get('applocale'), ['username' => $user->username]) }}
                                        </p>

                                        <!-- Display errors for the password -->
                            ...
                            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                <img style="width: 100%; height: 100%; object-fit: cover;" src="/Template/assets/img/potential-header-3.jpg" alt="header">
                            </div>
                        </div>
                        </div>
                    </div>
